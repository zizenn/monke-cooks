...
HOSTTYPE='x86_64'
outputDoc='out'
out='/nix/store/9hzapjkbgsl7kg77anx46wgq4w2ksd53-devenv-shell-env'
export out
...
export DEVENV_STATE
prefix='/nix/store/9hzapjkbgsl7kg77anx46wgq4w2ksd53-devenv-shell-env'
outputDevman='out'
depsBuildBuild=''
...
exec /tmp/devenv-envd6vyks/script 