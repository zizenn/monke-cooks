...
const int VISIBLE_COLS = 16;

const int VIRTUAL_WIDTH = TILE_SIZE*VISIBLE_COLS;
const int VIRTUAL_HEIGHT = TILE_SIZE*VISIBLE_ROWS;
...
>>>>>>> fa9d53e84ee9a4e5205540dc04a273fc50f4e6a1
  CloseAudioDevice();
  CloseWindow();
